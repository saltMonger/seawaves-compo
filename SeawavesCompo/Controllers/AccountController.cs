...
namespace SeawavesCompo.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private SeaWavesDBEntities db = new SeaWavesDBEntities();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //PARAMETERS
                    request.AddParameter("from", "compo@seawavescollective.net");
                    ...
                    try
                    {
                        client.ExecuteAsync(request, response =>
                        {
                            ...
                            {
                                //OK, continue
                                Console.WriteLine("sent email to new user: " + user.Id);
                            }
                            else
                            {
                                //NOT OKAY
                                AddErrors(new IdentityResult(new string[] { response.StatusCode.ToString(), response.ErrorMessage }));
                            }
                        });
                    }
                    catch
                    {
                        //do shite here
                        AddErrors(new IdentityResult(new string[] { "something terrible happened. please contact admin" }));
                        return View(model);
                    }
